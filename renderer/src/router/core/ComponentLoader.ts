...
export class ComponentLoader {
  ...
  constructor() {
    // Only include the retained application views.
    this.modules = {
      ...import.meta.glob('../../views/index/**/*.vue'),
      ...import.meta.glob('../../views/sessions/**/*.vue'),
      ...import.meta.glob('../../views/profiles/**/*.vue'),
      ...import.meta.glob('../../views/settings/**/*.vue'),
      ...import.meta.glob('../../views/llm/**/*.vue'),
      ...import.meta.glob('../../views/codex-config/**/*.vue')
    }
  }
